...
use crate::game::{
    components::{
        ...
        RecoveryRateBonus, SkillList, SkillPoints, SpawnOrigin, Stamina, StatPoints, StatusEffects,
        StatusEffectsRegen, SummonUsage, Team, UnionMembership,
    },
...
pub struct CharacterBundle {
    ...
    pub recovery_rate_bonus: RecoveryRateBonus,
